        ...
        <?php foreach ($roleUtilisateur as $role): ?>
                    ...
                    <section id="user-profil">
                        <section class="user-menu">
                            ...
                            <nav class="passagerLink">
                                <ul>
                                    <li><a href="/mesCovoiturages/">Covoiturages en cours</a></li>
                                    <li><a href="/historique/">Historique covoiturages</a></li>
                                </ul>
                            </nav>
                        </section>
                    </section>
                        ...
                        <section id="chauffeur-profil">
                            <section class="user-menu">
                                ...
                                <nav class="chauffeurLink">
                                    <ul>
                                        <li><a href="/trajet/">Saisir un voyage</a></li>
                                        <li><a href="/mesCovoiturages/">Covoiturages en cours</a></li>
                                        <li><a href="/historique/">Historique covoiturages</a></li>
                                        <li><a href="/vehicule/">Mes véhicules</a></li>
                                    </ul>
                                </nav>
                            </section>
                        </section>
            ...
            <?php elseif ($role === 'employe'): ?>
                <section class="user-menu">
                    ...
                    <nav class="passagerLink">
                        <ul>
                            <li><a href="/avisEnCours/">Avis en cours</a></li>
                            <li><a href="/historiqueAvis/">Historique avis</a></li>
                        </ul>
                    </nav>
                </section>
            ...
            <?php elseif ($role === 'admin'): ?>
                ...
                <p id="credit">Total des crédits gagné par la plateforme : <?= htmlspecialchars($graphiques['totalCredits']['totalCredits'] ?? 0) ?></p>
